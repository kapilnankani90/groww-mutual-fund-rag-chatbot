...
The system must strictly avoid providing investment advice, opinions, or recommendations. Every response must include a single, clear source link (except when the query is out of the knowledge base, in which case no citation link should be included) and adhere to defined constraints around clarity, accuracy, and compliance.
...
### 1. Corpus Definition
*   Currently limited to the following 5 URLs (using ICICI Prudential funds on Groww as context):
    1.  [ICICI Prudential Silver ETF FOF Direct Growth](https://groww.in/mutual-funds/icici-prudential-silver-etf-fof-direct-growth)
    2.  [ICICI Prudential Large Cap Fund Direct Growth](https://groww.in/mutual-funds/icici-prudential-large-cap-fund-direct-growth)
    3.  [ICICI Prudential Balanced Advantage Fund Direct Growth](https://groww.in/mutual-funds/icici-prudential-balanced-direct-growth)
    4.  [ICICI Prudential Liquid Fund Direct Plan Growth](https://groww.in/mutual-funds/icici-prudential-liquid-fund-direct-plan-growth)
    5.  [ICICI Prudential Corporate Bond Fund Direct Plan Growth](https://groww.in/mutual-funds/icici-prudential-corporate-bond-fund-direct-plan-growth)
...
*   Answer facts-only queries, such as:
    ...
    *   Benchmark index
    *   Fund management details (e.g., fund managers, tenure, education, or other schemes managed)
    *   Process to download statements or capital gains reports
*   Ensure:
    *   Each response is limited to a maximum of **3 sentences**
    *   Each response includes **exactly one** citation link (unless the query is out of the knowledge base, in which case no citation link should be included)
...
*   Every answer must include a source link (unless the query is out of the knowledge base) and last updated date
